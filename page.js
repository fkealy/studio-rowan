/* ============================================================================
   ...
   Assets are local: ./spin and ./media.
   ========================================================================== */
(function () {
  'use strict';
  ...
  if (form && done) (function () {
    ...
    var LABELS = { name: 'Name', email: 'Email', company: 'Company', quantity: 'Pairs needed',
                   needed_by: 'Would like to start', comments: 'Comments' };
    ...
    function byEmail(v) {
      ...
      location.href = 'mailto:' + SAMPLE_TO
        + '?subject=' + encodeURIComponent('Pilot partner request - ' + v.company)
